...
class GalleryPicture extends Table
    with TableInfo<GalleryPicture, GalleryPictureData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  GalleryPicture(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      'id', aliasedName, false,
      hasAutoIncrement: true,
      type: DriftSqlType.int,
  ...
  @override
  GalleryPicture createAlias(String alias) {
    return GalleryPicture(attachedDatabase, alias);
  }
}
...
class ProfilePicture extends Table
    with TableInfo<ProfilePicture, ProfilePictureData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ProfilePicture(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      'id', aliasedName, false,
      hasAutoIncrement: true,
      type: DriftSqlType.int,
  ...
  @override
  ProfilePicture createAlias(String alias) {
    return ProfilePicture(attachedDatabase, alias);
  }
}
...
class DatabaseAtV2 extends GeneratedDatabase {
  ...
  late final GalleryPicture galleryPicture = GalleryPicture(this);
  late final ProfilePicture profilePicture = ProfilePicture(this);
  @override
