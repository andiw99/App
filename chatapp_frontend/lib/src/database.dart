...
class Profile extends Person {
  TextColumn get firstName => text().withLength(min: 2, max: 128)();
  TextColumn get lastName => text().withLength(min: 2, max: 128)();

  TextColumn get bio => text().withLength(max: 1028)();
  TextColumn get email => text().withLength(max: 128)();

  IntColumn get phoneNumber => integer()();   // should this be an integercolumn?
...
class Friend extends Person {
  ...
  TextColumn get firstName => text().nullable().withLength(min: 2, max: 128)();       // nullable means it can be empty I hope, I dont have to know the actual names of my friends
  TextColumn get lastName => text().nullable().withLength(min: 2, max: 128)();

  TextColumn get bio => text().nullable().withLength(max: 1028)();
